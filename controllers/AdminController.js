...
const obtener_mesajes_admin = async function (req, res) {
    if (req.user) {
      ...
      if (req.user.rol == "admin") {
        ...
        for(var item of reg){
          ...
          if (createdAt_date.getFullYear() == current_year) {
            ...
            total_ganancias = total_ganancias + item.subtotal
...
module.exports ={registro_admin,login_admin,obtener_mesajes_admin,obtener_ventas_admin,kpi_ganancias_mensuales_admin}